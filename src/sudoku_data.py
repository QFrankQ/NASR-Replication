...
# 1.function add_noise: commented out the condition checking 
#                       "factor == 1" before the return statement
#================Changes Made in the File=========================
...
# Define the transformation (optional, here we are just converting images to tensors)
...
def add_noise(board,solution_board,min_noise,max_noise,factor,noise_input=True,min_noise_i=None,max_noise_i=None):     
    ...
    # commented out this condition so that the returned value is consistent
    # as an array of (9,9) boards even when factor is 1
    # if factor == 1:
